        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium transition ms-3">
                        Register
                    </a>
                @endauth
            </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                <div class="px-4 py-2 space-y-2">
                    ...
                    <a href="{{ route('register') }}" class="block bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-md text-base font-medium transition text-center">
                        Register
                    </a>
                </div>
            @endauth
