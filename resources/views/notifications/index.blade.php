        ...
        <div class="flex h-screen">
            ...
            <div class="hidden lg:flex w-64 bg-white border-r border-gray-200 flex-col fixed left-0 top-0 h-screen">
                ...
                <nav class="flex-1 px-4 py-6 space-y-4">
                    ...
                    <a href="{{ route('notifications.index') }}" class="flex items-center gap-4 px-4 py-3 rounded-full text-2xl font-bold">
            ...
            <div class="flex-1 lg:ml-64 max-w-2xl mx-auto w-full border-r border-gray-200">
                ...
                @if($notifications->isEmpty())
                    <div class="p-12 text-center">
                        ...
                        <p class="text-gray-600 text-lg font-semibold mb-2">No notifications yet</p>
                        <p class="text-gray-500">When someone likes or comments on your posts, you'll see it here</p>
                    </div>
                @else
                    <div class="divide-y divide-gray-200">
                        @foreach($notifications as $notification)
                            <div class="px-4 py-4 hover:bg-gray-50 transition cursor-pointer border-l-4 border-blue-500">
                                <div class="flex items-start gap-4">
                                    <!-- User Avatar -->
                                    <a href="{{ route('profile.show', $notification->fromUser) }}" class="flex-shrink-0">
                                        <div class="w-12 h-12 rounded-full bg-gradient-to-br {{ $notification->fromUser->getAvatarColors() }} flex items-center justify-center text-white font-bold text-sm">
                                    ...
                                    <div class="flex-1">
                                        <a href="{{ route('profile.show', $notification->fromUser) }}" class="font-bold text-gray-900 hover:text-blue-600">
